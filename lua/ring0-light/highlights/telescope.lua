...
M.highlights.telescope_matching = Highlight.new("TelescopeMatching", { link = ring0_hl.primary_bold })
...
M.highlights.telescope_selection_caret = Highlight.new("TelescopeSelectionCaret", { link = ring0_hl.primary })
