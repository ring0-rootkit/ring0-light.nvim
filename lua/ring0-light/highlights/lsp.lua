...
M.highlights.diagnostic_error = Highlight.new("DiagnosticError", { link = ring0_hl.red_bold })
...
M.highlights.diagnostic_underline_info = Highlight.new("DiagnosticUnderlineInfo", { link = ring0_hl.green_underline })

M.highlights.diagnostic_hint = Highlight.new("DiagnosticHint", { link = ring0_hl.wisteria })
M.highlights.diagnostic_sign_hint = Highlight.new("DiagnosticSignHint", { link = ring0_hl.wisteria_sign })
M.highlights.diagnostic_underline_hint =
	Highlight.new("DiagnosticUnderlineHint", { link = ring0_hl.wisteria_underline })
