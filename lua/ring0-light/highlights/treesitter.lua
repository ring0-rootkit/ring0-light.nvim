...
M.highlights.comment_documentation =
	Highlight.new("@comment.documentation", { link = ring0_hl.green, italic = opts.italic.comments })
...
---Brackets (e.g. `()` / `{}` / `[]`)
M.highlights.punctuation_bracket = Highlight.new("@punctuation.bracket", { link = ring0_hl.wisteria })
---Special symbols (e.g. `{}` in string interpolation)
M.highlights.punctuation_special = Highlight.new("@punctuation.special", { link = ring0_hl.brown })
...
-- M.highlights.attribute = Highlight.new("@attribute", { link = ring0_hl.brown })
---object and struct fields
M.highlights.field = Highlight.new("@field", { link = ring0_hl.niagara })
---similar to `@field`
M.highlights.property = Highlight.new("@property", { link = ring0_hl.dark_niagara })
