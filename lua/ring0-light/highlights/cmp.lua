...
M.highlights.cmp_item_abbr_match = Highlight.new("CmpItemAbbrMatch", { link = ring0_hl.primary_bold })
...
M.highlights.cmp_item_kind_color = Highlight.new("CmpItemKindColor", { fg = c.primary })
