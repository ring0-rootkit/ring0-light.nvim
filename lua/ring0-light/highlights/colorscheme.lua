...
M.highlights.primary = Highlight.new("ring0lightPrimary", { fg = c.primary })
M.highlights.primary_bold = Highlight.new("ring0lightPrimaryBold", { fg = c.primary, bold = opts.bold })
